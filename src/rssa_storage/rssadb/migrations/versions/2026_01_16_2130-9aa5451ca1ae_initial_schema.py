...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['created_by_id'], ['users.id'], name=op.f('fk_studies_created_by_id'), ondelete='SET NULL'
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['survey_construct_id'],
            ['survey_constructs.id'],
            name=op.f('fk_survey_items_survey_construct_id'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['survey_scale_id'],
            ['survey_scales.id'],
            name=op.f('fk_survey_scale_levels_survey_scale_id'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ['study_id'], ['studies.id'], name=op.f('fk_study_conditions_study_id'), ondelete='CASCADE'
        ),
        ...
        sa.UniqueConstraint(
            ...
            deferrable=True,
            initially='DEFERRED',
            name=op.f('uq_study_conditions_study_id_short_code'),
        ),
    )
    op.create_table(
        'study_steps',
        ...
        sa.UniqueConstraint(
            'study_id', 'path', deferrable=True, initially='deferred', name=op.f('uq_study_steps_study_id_path')
        ),
    )
    op.create_table(
        'study_step_pages',
        ...
        sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ['study_id'], ['studies.id'], name=op.f('fk_study_step_pages_study_id'), ondelete='CASCADE'
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_study_step_pages_study_step_id'), ondelete='CASCADE'
        ),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_study_step_pages')),
        sa.UniqueConstraint(
            'study_step_id', 'order_position', name=op.f('uq_study_step_pages_study_step_id_order_position')
        ),
    )
    op.create_table(
        'study_participants',
        ...
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(
            ['current_page_id'], ['study_step_pages.id'], name=op.f('fk_study_participants_current_page_id')
        ),
        sa.ForeignKeyConstraint(
            ['current_step_id'], ['study_steps.id'], name=op.f('fk_study_participants_current_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_condition_id'], ['study_conditions.id'], name=op.f('fk_study_participants_study_condition_id')
        ),
        sa.ForeignKeyConstraint(['study_id'], ['studies.id'], name=op.f('fk_study_participants_study_id')),
        sa.ForeignKeyConstraint(
            ['study_participant_type_id'],
            ['study_participant_types.id'],
            name=op.f('fk_study_participants_study_participant_type_id'),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['study_step_page_id'],
            ['study_step_pages.id'],
            name=op.f('fk_study_step_page_contents_study_step_page_id'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['survey_construct_id'],
            ['survey_constructs.id'],
            name=op.f('fk_study_step_page_contents_survey_construct_id'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['survey_scale_id'],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['study_participant_id'], ['study_participants.id'], name=op.f('fk_feedbacks_study_participant_id')
        ),
        sa.ForeignKeyConstraint(['study_step_id'], ['study_steps.id'], name=op.f('fk_feedbacks_study_step_id')),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'], ['study_step_pages.id'], name=op.f('fk_feedbacks_study_step_page_id')
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f('fk_participant_demographics_study_participant_id'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_freeform_responses_study_participant_id'),
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_participant_freeform_responses_study_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'],
            ['study_step_pages.id'],
            name=op.f('fk_participant_freeform_responses_study_step_page_id'),
        ),
        ...
        sa.UniqueConstraint(
            ...
            'study_participant_id',
            'context_tag',
            name=op.f('uq_participant_freeform_responses_study_id_study_part_8006a1'),
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_interaction_logs_study_participant_id'),
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_participant_interaction_logs_study_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'],
            ['study_step_pages.id'],
            name=op.f('fk_participant_interaction_logs_study_step_page_id'),
        ),
        ...
        sa.UniqueConstraint(
            ...
            'study_participant_id',
            'context_tag',
            name=op.f('uq_participant_interaction_logs_study_id_study_partic_6aa83f'),
        ),
    )
    op.create_table(
        'participant_ratings',
        ...
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_ratings_study_participant_id'),
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_participant_ratings_study_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'], ['study_step_pages.id'], name=op.f('fk_participant_ratings_study_step_page_id')
        ),
    ...
    op.create_table(
        ...
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(
            ['study_id'], ['studies.id'], name=op.f('fk_participant_recommendation_contexts_study_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_recommendation_contexts_study_participant_id'),
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_participant_recommendation_contexts_study_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'],
            ['study_step_pages.id'],
            name=op.f('fk_participant_recommendation_contexts_study_step_page_id'),
        ),
        ...
        sa.UniqueConstraint(
            ...
            'study_participant_id',
            'context_tag',
            name=op.f('uq_participant_recommendation_contexts_study_id_study_9290cf'),
        ),
    )
    op.create_table(
        ...
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(
            ['study_id'], ['studies.id'], name=op.f('fk_participant_study_interaction_responses_study_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_study_interaction_responses_study_participant_id'),
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_participant_study_interaction_responses_study_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'],
            ['study_step_pages.id'],
            name=op.f('fk_participant_study_interaction_responses_study_step_page_id'),
        ),
        ...
        sa.UniqueConstraint(
            ...
            'study_participant_id',
            'context_tag',
            name=op.f('uq_participant_study_interaction_responses_study_id_s_5834e0'),
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_study_sessions_study_participant_id'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_participant_survey_responses_study_participant_id'),
        ),
        sa.ForeignKeyConstraint(
            ['study_step_id'], ['study_steps.id'], name=op.f('fk_participant_survey_responses_study_step_id')
        ),
        sa.ForeignKeyConstraint(
            ['study_step_page_id'],
            ['study_step_pages.id'],
            name=op.f('fk_participant_survey_responses_study_step_page_id'),
        ),
        sa.ForeignKeyConstraint(
            ['survey_construct_id'],
            ['survey_constructs.id'],
            name=op.f('fk_participant_survey_responses_survey_construct_id'),
        ),
        sa.ForeignKeyConstraint(
            ['survey_item_id'],
            ['survey_items.id'],
            name=op.f('fk_participant_survey_responses_survey_item_id'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['survey_scale_id'], ['survey_scales.id'], name=op.f('fk_participant_survey_responses_survey_scale_id')
        ),
        sa.ForeignKeyConstraint(
            ['survey_scale_level_id'],
            ['survey_scale_levels.id'],
            name=op.f('fk_participant_survey_responses_survey_scale_level_id'),
            ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f('fk_study_participant_movie_sessions_assigned_list_id'),
            ondelete='CASCADE',
        ),
        sa.ForeignKeyConstraint(
            ['study_participant_id'],
            ['study_participants.id'],
            name=op.f('fk_study_participant_movie_sessions_study_participant_id'),
            ondelete='CASCADE',
        ),
