...
down_revision: str | None = 'ca9f562ddf68'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        new_fk_entity_construct_item_id, new_table_name, 'construct_item', ['item_id'], ['id'], ondelete='SET NULL'
    )
...
def downgrade() -> None:
    ...
    # foreign key with construct_item
    op.create_foreign_key(
        old_fk_entity_construct_item_id, old_table_name, 'construct_item', ['item_id'], ['id'], ondelete='SET NULL'
    )
