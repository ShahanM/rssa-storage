...
down_revision: str | None = '91c00d8fbb1d'
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


def upgrade() -> None:
    op.add_column('page_content', sa.Column('scale_id', UUID(as_uuid=True), nullable=True))
    ...
    op.drop_constraint('fk_construct_item_construct_item_type_id', 'construct_item', type_='foreignkey')
    ...
    op.add_column('construct_scale', sa.Column('description', sa.String(), nullable=True))
    print("Added 'description' column to 'construct_scale'.")

    op.add_column('construct_scale', sa.Column('created_by', sa.String(), nullable=True))
