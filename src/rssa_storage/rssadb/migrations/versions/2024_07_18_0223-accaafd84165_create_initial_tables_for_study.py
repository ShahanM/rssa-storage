...
def upgrade() -> None:
    ...
    op.create_index('study_step_study_id_order_position_key', 'study_step', ['study_id', 'order_position'], unique=True)
    ...
    op.create_index(
        'page_study_id_step_id_order_position_key', 'step_page', ['study_id', 'step_id', 'order_position'], unique=True
    )
