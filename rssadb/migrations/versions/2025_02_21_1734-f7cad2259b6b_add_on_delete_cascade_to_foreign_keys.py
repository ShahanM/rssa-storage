...
def upgrade() -> None:
    ...
    op.create_foreign_key('study_condition_study_id_fkey', 'study_condition', 'study', ['study_id'], ['id'], ondelete='CASCADE')

    op.drop_constraint('feedback_participant_id_fkey', 'feedback', type_='foreignkey')
    op.create_foreign_key('feedback_participant_id_fkey', 'feedback', 'study_participant', ['participant_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('demographics_participant_id_fkey', 'demographics', 'study_participant', ['participant_id'], ['id'], ondelete='CASCADE')


def downgrade() -> None:
    op.drop_constraint('demographics_participant_id_fkey', 'demographics', type_='foreignkey')
    op.create_foreign_key('demographics_participant_id_fkey', 'demographics', 'study_participant', ['participant_id'], ['id'])
